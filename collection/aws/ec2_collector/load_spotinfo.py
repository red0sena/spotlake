...
def get_spotinfo():
    ...
    if 'spotinfo' in os.listdir('/home/ubuntu/spot-score/collection/aws/ec2_collector/'):
        command = ['', '', '/home/ubuntu/spot-score/collection/aws/ec2_collector/spotinfo --output csv --region all']
    else:
        command = ['wget https://github.com/alexei-led/spotinfo/releases/download/1.0.7/spotinfo_linux_amd64 -O /home/ubuntu/spot-score/collection/aws/ec2_collector/spotinfo', 'chmod +x /home/ubuntu/spot-score/collection/aws/ec2_collector/spotinfo', '/home/ubuntu/spot-score/collection/aws/ec2_collector/spotinfo --output csv --region all']
